...
for snippet in "contents: write" "attestations: write" "id-token: write" "softprops/action-gh-release@3bb12739c298aeb8a4eeaf626c5b8d85266b0e65" "actions/attest-build-provenance@96b4a1ef7235a096b17240c259729fdd70c83d45" "sbom-"; do

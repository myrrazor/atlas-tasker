...
func TestRootCommandIncludesRequiredTopLevelCommands(t *testing.T) {
	...
	required := []string{
		...
		"who", "sweep", "inspect", "automation", "notify", "git", "views", "watch", "unwatch", "bulk", "templates", "setup", "integrations", "search", "render", "web", "version", "shell", "mcp", "tui", "uninstall", "workspaces",
	}
...
func TestRootCommandIncludesRequiredV17ContractCommandsAndFlags(t *testing.T) {
	...
	contracts := []commandContract{
		...
		{path: []string{"backup", "drill"}, hasOutputMode: true, extraFlags: []string{"target"}},
		{path: []string{"backup", "target", "add"}, hasOutputMode: true, extraFlags: []string{"url", "acknowledge-data-boundary", "allow-local-file"}},
		{path: []string{"backup", "target", "list"}, hasOutputMode: true},
		{path: []string{"backup", "target", "view"}, hasOutputMode: true},
		{path: []string{"backup", "target", "edit"}, hasOutputMode: true},
		{path: []string{"backup", "target", "remove"}, hasOutputMode: true},
		{path: []string{"backup", "auto", "status"}, hasOutputMode: true},
		{path: []string{"backup", "auto", "enable"}, hasOutputMode: true, extraFlags: []string{"target"}},
		{path: []string{"backup", "auto", "disable"}, hasOutputMode: true},
		{path: []string{"backup", "replica", "view"}, hasOutputMode: true},
		{path: []string{"backup", "replica", "reset"}, hasOutputMode: true, extraFlags: []string{"yes"}},
		{path: []string{"backup", "reconcile"}, hasOutputMode: true, extraFlags: []string{"yes"}},
		{path: []string{"backup", "remote", "list"}, hasOutputMode: true, extraFlags: []string{"target"}},
		{path: []string{"backup", "remote", "verify"}, hasOutputMode: true, extraFlags: []string{"target"}},
		{path: []string{"backup", "remote", "restore-plan"}, hasOutputMode: true, extraFlags: []string{"target"}},
		{path: []string{"backup", "remote", "restore-apply"}, mutating: true, hasOutputMode: true, extraFlags: []string{"yes", "target"}},
		{path: []string{"backup", "schedule", "plan"}, hasOutputMode: true},
		{path: []string{"backup", "schedule", "install"}, hasOutputMode: true, extraFlags: []string{"yes"}},
		{path: []string{"backup", "schedule", "status"}, hasOutputMode: true},
		{path: []string{"backup", "schedule", "remove"}, hasOutputMode: true, extraFlags: []string{"yes"}},
		{path: []string{"backup", "schedule", "repair"}, hasOutputMode: true, extraFlags: []string{"yes"}},
		{path: []string{"backup", "prune", "plan"}, hasOutputMode: true},
		{path: []string{"backup", "prune", "apply"}, hasOutputMode: true, extraFlags: []string{"yes"}},

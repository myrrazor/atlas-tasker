...
5. run `VERSION=v1.13.0-rc1 ./scripts/verify-release.sh <archive>` with attestation verification enabled
6. install from published assets with `VERSION=v1.13.0-rc1 BIN_DIR=<clean-dir> sh scripts/install.sh`

# Atlas Tasker Agent Guide (v1 archive)

> Archived. This was the root `AGENTS.md` during the v1 build — contributor rules for the
> people and agents writing Atlas, written when the PR-001..PR-009 train was still running.
> The decision-log convention below is still live. The root [AGENTS.md](../AGENTS.md) is now
> for agents *using* the tracker; contributor rules live in [CONTRIBUTING.md](../CONTRIBUTING.md).

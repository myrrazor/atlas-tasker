...
- `go run github.com/CycloneDX/cyclonedx-gomod/cmd/cyclonedx-gomod@v1.10.0 app -json -output docs/release-proof/sbom-v1.15.0-rc1.cdx.json -main cmd/tracker .`
...
```bash
VERSION=v1.15.0-rc1 sh scripts/preflight-release.sh --hosted
```
